...
import ProfileMenu, { Menu } from './ProfileMenu'
      ...
      if (isMobileMenuVisible) return (
        ...
        <nav className={css.NavbarH}>
         ...
         <nav className={css.NavbarH}>
           ...
           <span className={css.navRight}>
             {user?  
               <><PostVideoButton/><Profile user={user}/></>
...
const MobileProfileButton = ({ onClick, user }) => (
  <>
  {user?
    <div onClick={onClick} className={css.profileItem}>{user.channelName}</div>
  :
...
const MobileProfileMenu = ({ isOpen, setIsOpen, user }) => {
  const dispatch = useDispatch()
  ...
  return (
    <MobileMenu style={{display: isOpen? 'flex' : 'none'}}>
      ...
      :
        <> 
        <NavLink to='/login' onClick={closeProfileMenu}>
          Log In
        </NavLink>
        <NavLink to='/signup' onClick={closeProfileMenu}>
          Sign Up
        </NavLink>
        </>
      }
